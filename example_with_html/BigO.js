...
getBigOBtn.onclick = function() {
    ...
    /////// now parse the textMAIN FUNCTION THAT I NEED TO COPY/////////////
    var result = parseInput(code, codeAnalysis);
    // set the result
    var resultShow = document.getElementById("resultShow");;
    //there is just passed the tag and complexity. nothing special
...
function parseInput(code, codeAnalysis) {
    // get the for statement and save them as array of strings for each line
